...
class Controller(controller.BaseController):
    ...
    @staticmethod
    def _copy_from(req):
        return req.headers.get('x-sios-api-copy-from')
    ...
    def _upload(self, req, image_meta):
        ...
        Sios. If the `x-image-meta-store` header is set, Sios
        will attempt to use that scheme; if not, Sios will use the
    ...
    def _activate(self, req, image_id, location):
        ...
        :param location: Location of where Sios stored this image
        """
        image_meta = {}
    ...
    def create(self, req, image_meta, image_data):
        """
        Adds a new image to Sios. Four scenarios exist when creating an
        image:
        ...
        2. If the image data exists somewhere else, you can upload indirectly
           from the external source using the x-sios-api-copy-from header.
           ...
           sios image store.  State transitions are as for option #1.
        ...
        3. If the image data exists somewhere else, you can reference the
           ...
           to the configured sios image store.
    ...
    def update(self, req, id, image_meta, image_data):
        ...
        purge_props = req.headers.get('x-sios-registry-purge-props', True)
    ...
    def delete(self, req, id):
        """
        Deletes the image and all its chunks from the Sios
        ...
        try:
            ...
            # See https://bugs.launchpad.net/sios/+bug/747799
            if image['location']:
